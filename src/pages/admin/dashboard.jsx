...
function DashboardAdmin() {
  ...
  const handleConfirmDelete = async (id) => {
    await dispatch(getDeletePeserta(id, toast));
    await dispatch(allUsers()); // Refresh the user list after deletion
    toggleDeleteConfirm();
  };
    ...
    <div className="flex flex-col maxsm:bg-gray-100">
      ...
      <div className="relative flex flex-grow">
        ...
        <main className="flex-grow lg:ml-[250px] p-8 mt-[63px] lg:mt-20 z-10">
            ...
            <table className="min-w-full table-auto">
              <thead>
                <tr className="text-left align-top">
                  ...
                  <th className="py-2 px-4 font-medium flex justify-center text-gray-600">
                    Aksi
                  </th>
                </tr>
              </thead>
              <tbody>
                {currentUsers.map((user, index) => (
                  <tr key={index} className="border-b align-top">
                    ...
                    <td
                      className={`flex justify-center text-center line-block mb-1 px-2 py-1 rounded-md ${
                    ...
                    <td className="py-3 px-7 flex justify-end gap-2">
                      <button
                        className="text-white hover:bg-blue-700 bg-blue-500 rounded-md px-2 py-1"
          ...
          <Modal isOpen={isConfirmDeleteOpen} onClose={toggleDeleteConfirm}>
            {selectedUser && (
              <div className="p-3">
                <p>
                  Apakah Anda yakin ingin menghapus peserta {selectedUser?.name}{" "}
                  ?
                </p>
                <div className="flex justify-end mt-4">
                  ...
                  <button
                    ...
                    onClick={() => {
                      handleConfirmDelete(selectedUser?.id);
                    }}
                  >
                    Hapus
                  </button>
